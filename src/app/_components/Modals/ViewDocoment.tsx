...
const ViewDocoment: React.FC<ViewDocomentProps> = ({
	onClick,
	open,
	onClose,
	title,
			...
			<div className={styles.investmentModal}>
				...
				<div className={styles.investmentContent}>
					<div className={styles.docParent}>
						<div className={`${styles.heading} ${styles.aligment}`}>
							<p>
								서류 <span className={styles.require}></span>
							</p>
						</div>
				...
				<div className={styles.investmentBtns}>
					<Button
						className={`${styles.btnCancle1} ${styles.border}`}
						onClick={onClose}
					>
						파일 다운로드
					</Button>
